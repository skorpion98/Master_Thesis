...
\begin{abstract}
	...
	We will show that, unfortunately, these frameworks are indeed missing a relevant amount of bugs. These bugs can be detected starting from publicly available data with low effort and many of them have security implication. After reporting all the bugs we found during our evaluation, we contacted the maintainers of such frameworks and proposed them new approaches to limit the amount of overlooked bugs.
