...
\newline \newline
\textit{Valgrind} \cite{Valgrind_1}\cite{Valgrind_2} is an instrumentation framework to perform memory analysis, profiling and management during the execution of a program.
