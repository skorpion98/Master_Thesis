...
The \textit{Address Sanitizer} \cite{asan_paper} is a memory error detection tool for C/C++ that helps developers to find and fix any out-of-bounds accesses to heap, stack and global objects as well as use-after-free bugs, and its one of the most widely used and effective sanitizers.
\newline \newline
...
\caption{Memory mapping of ASan \cite{asan_paper}}
...
\ \\
\subsection{MSan}
The \textit{Memory Sanitizer} \cite{msan_paper} is a memory reads detector for C/C++ that helps developers to find and fix use-of-uninitialized-memory (UUM) bugs.
...
\caption{Memory mapping of MSan \cite{msan_paper}}
