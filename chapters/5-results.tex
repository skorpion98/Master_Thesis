...
These results show the effectiveness of continuously testing and maintaining up to date your projects, especially considering that FuzzBench tests these projects on older versions that the one that was used for these tests. 
...
\newpage
\section{Discussion}
\ziosaba{Discuss the overall results, what was expected and what was unexpected...
