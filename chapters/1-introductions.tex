...
\section{Context}
One of the most important goals of software testing is \textit{finding bugs}, defects in the code causing unwanted and unexpected results, that hinder the security of the product and may lead to vulnerabilities being exploited by malicious people. \matteo{Automated testing is not a technique, is more of an approach; moreover, it is not tailored to fuzzing (i.e. you should change the part about controlling the execution flow).} In this context, a popular technique is \textit{automated testing}, which is based on using a tool to control the execution flow of the software being tested and analyze its results via repetitive tasks performed over long periods of time. 
...
\matteo{I find this introduction to be okay up to here; you should write something more in this subsection though; Give a few more details about what you do in this thesis and the results, but keep a high level of description and most importantly avoid technical stuff.}
