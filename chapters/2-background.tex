...
\newpage
\begin{figure}[h]
\makebox[\textwidth][c]{\includegraphics[width=0.665\paperwidth]{foto/how_fuzzer_works.jpg}}
...
\begin{figure}[h]
\makebox[\textwidth][c]{\includegraphics[width=0.6\paperwidth]{foto/cfg.png}}
...
\begin{figure}[h]
\makebox[\textwidth][c]{\includegraphics[width=0.6\paperwidth]{foto/fuzzing_steps.png}}
