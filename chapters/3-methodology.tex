...
\matteo{Why are you using a screen from vscode (or whatever it is) instead of doing a latex table? If 50 subjects do not fit in one page you could divide it into more columns}
\begin{figure}[h]
\centering
...
\matteo{Wouldn't it be better to make a table out of this as well? (this is a minor thing though)}
\begin{itemize}
